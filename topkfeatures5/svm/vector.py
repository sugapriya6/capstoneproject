...
plt.legend()
plt.grid(True)
plt.savefig("C:/capstone/alzheimers/proposed/topkfeatures5/svm/svm_metrics.png", dpi=300, bbox_inches="tight")
...
# ==============================
# SAVE FINAL SVM MODEL FOR REAL-TIME USE
# ==============================
...
print("Saving SVM model with best k =", best_k)
...
joblib.dump(final_svm_model, MODEL_DIR + "svm_model.joblib")
joblib.dump(final_selector, MODEL_DIR + "svm_selector.joblib")
joblib.dump(X.columns[final_selector.get_support()], MODEL_DIR + "svm_features.joblib")

print("✅ SVM model, selector, and features saved successfully")
