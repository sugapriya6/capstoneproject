...
plt.legend()
plt.grid(True)
plt.savefig("C:/capstone/alzheimers/proposed/topkfeatures5/random/random_metrics.png", dpi=300, bbox_inches="tight")
...
# ==============================
# SAVE FINAL MODEL FOR REAL‑TIME USE (RANDOM FOREST)
# ==============================
...
print("Saving Random Forest model with best k =", best_k)
...
joblib.dump(final_rfe, MODEL_DIR + "rf_rfe.joblib")
joblib.dump(X.columns[final_rfe.support_], MODEL_DIR + "rf_features.joblib")

print("✅ Random Forest model saved successfully for real‑time inference")
