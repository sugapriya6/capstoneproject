...
et_classifier = joblib.load(MODEL_DIR + "et_model.joblib")
selected_features = joblib.load(MODEL_DIR + "et_features.joblib")
...
# PREDICTION
# ==============================
y_real_pred = et_classifier.predict(X_real_final)
y_real_prob = et_classifier.predict_proba(X_real_final)[:, 1]
...
# SAVE TO CSV
# ==============================
OUTPUT_PATH = "C:/capstone/alzheimers/proposed/topkfeatures5/extratree/realtime_predictions.csv"
