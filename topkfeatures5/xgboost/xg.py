...
plt.legend()
plt.grid(True)
plt.savefig("C:/capstone/alzheimers/proposed/topkfeatures5/xgboost/xgboost_metrics.png", dpi=300, bbox_inches="tight")
...
# ==============================
# SAVE FINAL XGBOOST MODEL FOR REAL‑TIME USE
# ==============================
...
print("Saving XGBoost model with best k =", best_k)
...
# Save model, RFE object, and selected feature names
joblib.dump(final_model, MODEL_DIR + "xgb_model.joblib")
joblib.dump(final_rfe, MODEL_DIR + "xgb_rfe.joblib")
joblib.dump(X.columns[final_rfe.support_], MODEL_DIR + "xgb_features.joblib")

print("✅ XGBoost model saved successfully for real‑time inference")
